...
// Mock Data - Dito muna manggagaling ang balita natin
// src/services/newsService.ts
...
export const MOCK_ARTICLES: Article[] = [
  ...
  },
  {
    ...
    summary:
      "A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance. A first look at the shared element transitions and improved worklet performance.",
...
export const newsService = {
  // Ginawa nating "async" para kunyari ay nag-fefetch sa internet
  getLatestNews: async (): Promise<Article[]> => {
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve(MOCK_ARTICLES);
      }, 800); // Kunyari may loading time na 800ms
    });
  },
};
